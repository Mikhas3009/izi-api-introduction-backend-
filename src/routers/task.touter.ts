...
export class TaskRouter extends BaseRouter<TaskController> {
    ...
    protected registerRoutes(): void {
        ...
        this.router.post("/api/tasks", validateAndTransformTask, this.controller.addTask.bind(this.controller));
        this.router.patch("/api/tasks/:id", validateAndTransformTask, this.controller.setTaskStasus.bind(this.controller));
